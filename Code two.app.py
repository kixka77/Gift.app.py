# app.py
# Pages for Nay - Streamlit Storybook (Fixed)
...
st.markdown(
    '<div style="text-align:center"><div class="cover-title">Pages for Nay 💌</div>'
    '<div class="cover-sub">A little story for your birthday</div></div>',
    unsafe_allow_html=True
)

if not st.session_state.secret_unlocked and st.session_state.page_idx < len(PAGES):
    ...
    with col2:
        st.markdown(
            ...
            '<span class="small">click the cat to unlock a secret</span></div>',
            unsafe_allow_html=True
        )
    ...
    <div class="page-wrap">
      <div class="panel">
        ...
        <div class="content">
          ...
          <p style="color:#c9a6e0;font-weight:700">See you someday ♡</p>
        </div>
      </div>
    </div>
    """
...
st.markdown(
    "<div style='text-align:center;margin-top:10px;color:#87606f;font-size:0.9rem'>Made with care — a soft story for Nay 💗</div>",
    unsafe_allow_html=True
)
